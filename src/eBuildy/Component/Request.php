...
class Request implements \ArrayAccess
{
    ...
    /**
     * @var \eBuildy\Component\ParameterBag
     */
    public $routeData;
    ...
    public function initialize(array $query = array(), array $request = array(), array $attributes = array(), array $cookies = array(), array $files = array(), array $server = array(), $content = null)
    {
        ...
        $this->headers = new ParameterBag($this->getHeaders($server));
        $this->routeData = new ParameterBag();
    ...
    {
        return $this->query->get($key, $this->attributes->get($key, $this->request->get($key, $this->routeData->get($key, $default, $deep), $deep), $deep), $deep);
    }
